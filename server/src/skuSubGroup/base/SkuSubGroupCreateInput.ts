...
class SkuSubGroupCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => SkuCreateNestedManyWithoutSkuSubGroupsInput,
  })
  @ValidateNested()
  @Type(() => SkuCreateNestedManyWithoutSkuSubGroupsInput)
  @IsOptional()
  @Field(() => SkuCreateNestedManyWithoutSkuSubGroupsInput, {
    nullable: true,
  })
