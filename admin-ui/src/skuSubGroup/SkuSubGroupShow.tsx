...
import { SKUSUBGROUP_TITLE_FIELD } from "./SkuSubGroupTitle";

export const SkuSubGroupShow = (props: ShowProps): React.ReactElement => {
  return (
    <Show {...props}>
      <SimpleShowLayout>
        ...
        <ReferenceManyField reference="Sku" target="SkuSubGroupId" label="Skus">
